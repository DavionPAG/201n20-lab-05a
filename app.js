...
function multiply(a, b, c) { //eslint-disable-line
  var prod = (a * b);
  var str2 = `The product of ${a} and ${b} is ${prod}.`;
  //console.log([prod, str2]);
  return [prod, str2];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < testDynamicArray.length; i++){
    prod = multiply(testDynamicArray[i], prod)[0];
  }
  var str = `The numbers ${testDynamicArray} have a product of ${prod}.`;
